...
function generateContent(event) {
  ...
  let context = `You are an inspirational ${contentOption.value} writer who loves to write simple ${contentOption.value}. Generate a very short ${contentOption.value} in basic HTML and separate each sentence with <br/>. Do not show the title of the ${contentOption.value}. Make sure to follow the user instructions. At the bottom, sign it 'SheCodes AI' in a <strong>`;
